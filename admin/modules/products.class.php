...
if ( class_exists( "products" ) == false ) {
	class products
    {
        ...
        private function loadFormAlterProductFrom($number)
        {
            ...
            echo "Pre&ccedil;o do item ".GOLDNAME.":<br />\n<input type=\"text\" value=\"{$findDetailsItem->price}\" id=\"price\" name=\"price\" /><br />\n";
            echo "Pre&ccedil;o do item ".CASHNAME.":<br />\n<input type=\"text\" value=\"{$findDetailsItem->CashPrice}\" id=\"cashprice\" name=\"cashprice\" /><br />\n";
        ...
        {   
            ...
            $this->cashprice    = (int)$_POST['cashprice'];
        ...
        private function loadFormIncludeProductFrom()
        {
            ...
            echo "Pre&ccedil;o do item ".CASHNAME.":<br />\n<input type=\"text\" value=\"1\" id=\"cashprice\" name=\"cashprice\" /><br />\n";
