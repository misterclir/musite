    ...
    class ldRankings extends ldMssql { 
        ...
        {    
            ...
            if(mssql_num_rows($findDetailsQ) > 0)
            {
                ...
                if($findDetails->Class == 0 || $findDetails->Class == 1 || $findDetails->Class == 2 || $findDetails->Class == 3){
                    $imagem_class = "SM";
                }
                elseif($findDetails->Class == 16 || $findDetails->Class == 17 || $findDetails->Class == 18 || $findDetails->Class == 19){
                    $imagem_class = "BK";
                }
                elseif($findDetails->Class == 32 || $findDetails->Class == 33 || $findDetails->Class == 34 || $findDetails->Class == 35){
                    $imagem_class = "ME";
                }
                elseif($findDetails->Class == 48 || $findDetails->Class == 50 || $findDetails->Class == 51){
                    $imagem_class = "MG";
                }
                elseif($findDetails->Class == 64 || $findDetails->Class == 66 || $findDetails->Class == 67){
                    $imagem_class = "LE";
                }
				elseif($findDetails->Class == 81 || $findDetails->Class == 82 || $findDetails->Class == 83){
                    $imagem_class = "BS";
                }
				elseif($findDetails->Class == 96 || $findDetails->Class == 97 || $findDetails->Class == 98){
                    $imagem_class = "RF";
                }
				elseif($findDetails->Class == 112 || $findDetails->Class == 114 || $findDetails->Class == 115){
                    $imagem_class = "GL";
                }
				
                $ResetCount = $findDetails->ascensao;
                $Name = $this->name;
                $Classe = $findDetails->Class;

              if($ResetCount >= 0 AND $ResetCount <= 20){
              ...
              if($ResetCount <= 0){
                  ...
                  elseif($ResetCount <= 10){
                      $Honra = 'Platina';
                  }
                  elseif($ResetCount <= 11){
                      $Honra = 'Platina II';
                  }
                  elseif($ResetCount <= 12){
                      $Honra = 'Platina III';
                  }
                  elseif($ResetCount <= 13){
                      $Honra = 'Diamante';
                  }
                  elseif($ResetCount <= 14){
                      $Honra = 'Diamante II';
                  }
                  elseif($ResetCount <= 15){
                      $Honra = 'Diamante III';
                  }
                  elseif($ResetCount <= 16){
                      $Honra = 'Veterano';
                  }
                  elseif($ResetCount <= 17){
                      $Honra = 'Veterano II';
                  }
                  elseif($ResetCount <= 18){
                      $Honra = 'Comando Maior';
                  }
                  elseif($ResetCount <= 999){
                      $Honra = 'Platina V';
                  }
                  elseif($ResetCount <= 999){
                      $Honra = 'Diamante';
                ...
                $this->returnRanking .= "<link href=\"templates/".TEMPLATE_DIR."/css/profile.css?1\" media=\"all\" rel=\"stylesheet\" type=\"text/css\" />
                    ...
                    <div id=\"qfpback\">          
                        <div id=\"fpemperor\"><img src=\"templates/".TEMPLATE_DIR."/img/profile/honra/".$Honra.".png\" style=\"pointer-events: none;width: 70px;\"></div>
                    </div>
                    ...
                    <div id=\"tranking\">
                        ...
                        <div class=\"qranking\" id=\"qdiario\">
                            <table width=\"263\">
                                <tbody><tr height=\"25\">
                                    <td width=\"145\"><strong>Hunt Point:</strong> {$findDetails->mresetsday}</td> 
                        ...
                        <div class=\"qranking\" id=\"qsemanal\" style=\"display:none;\">
                            <table width=\"263\">
                                <tbody><tr height=\"25\">
                                    <td width=\"145\"><strong>Hunt Point:</strong> {$findDetails->mresetswek}</td> 
                        ...
                        <div class=\"qranking\" id=\"qmensal\" style=\"display:none;\">
                            <table width=\"263\">
                                <tbody><tr height=\"25\">
                                    <td width=\"145\"><strong>Hunt Point:</strong> {$findDetails->mresetsmon}</td> 
                        ...
                        <div class=\"qranking\" id=\"qtotal\" style=\"display:none;\">
                            <table width=\"263\">
                                <tbody><tr height=\"25\">
                                    <td width=\"145\"><strong>Hunt Point:</strong> {$findDetails->mresets}</td> 
        ...
        private function gerateRankingResets()
        {
            ...
            elseif($_GET['top'] == 200) $ex_top = 200;
             ...
             Select TOP $ex_top AccountID, Name, Class, clevel, ".COLUMN_PK_RANKING.", ".COLUMN_RESETS.", ".COLUMN_RESETS_DAY.", ".COLUMN_RESETS_WEEK.", ".COLUMN_RESETS_MONTH.",".COLUNN_ASCENCAO.",image from dbo.Character ". 
             ...
             while($busca_dados = mssql_fetch_array($busca_dados_q)) {
              ...
              $checkMemberVip = mssql_fetch_object($checkMemberVipQ);
              $ResetCount = $busca_dados[''.COLUNN_ASCENCAO.''];
              $Classe = $busca_dados['Class'];
              $Name = $busca_dados['Name'];
              $img = $busca_dados['image'];
              if($ResetCount >= 1 AND $ResetCount <= 20){
                  if(file_exists("modules/uploads/photos".$img) == false || empty($img) == true) $img = "0.jpg";
                  $imagem = '<img src="modules/uploads/photos/'.$img.'" alt="'.$Name.'" />';
              }
              elseif($ResetCount >= 999 || $ResetCount < 999 AND $Classe == 0 AND $Classe == 1 AND $Classe == 2){
              ...
              if($ResetCount <= 1){
                  ...
                  elseif($ResetCount <= 19){
                      $Honra = 'Comando Maior';
                  }
                  elseif($ResetCount <= 20){
                      $Honra = 'Master Comando';
                  }
                  elseif($ResetCount <= 21){
                      $Honra = 'Master Comando II';
                  }
                  elseif($ResetCount <= 999){
                      $Honra = 'Diamante II';
                  }
        ...
        private function gerateRankingHonra()
        {
            ...
            elseif($_GET['top'] == 200) $ex_top = 200;
             ...
             $busca_dados_q = $this->query("USE MuOnline
             Select TOP $ex_top AccountID, Name, Class, clevel, ".COLUMN_PK_RANKING.", ".COLUNN_ASCENCAO.", ".COLUMN_RESETS_DAY.", ".COLUMN_RESETS_WEEK.", ".COLUMN_RESETS_MONTH.",image from dbo.Character ". 
                ($_GET['period'] == 0 ? "".COLUNN_ASCENCAO."" : 
                ($_GET['period'] == 1 ? "".COLUMN_RESETS_WEEK."" : 
                ($_GET['period'] == 2 ? "".COLUMN_RESETS_MONTH."" : 
                    "".COLUNN_ASCENCAO.""))) ." order by ". 
                ($_GET['period'] == 0 ? "".COLUNN_ASCENCAO." desc" : 
                    ($_GET['period'] == 1 ? "".COLUMN_RESETS_WEEK." desc, ".COLUNN_ASCENCAO." desc" : 
                        ($_GET['period'] == 2 ? "".COLUMN_RESETS_MONTH." desc, ".COLUNN_ASCENCAO." desc" :
                            ($_GET['period'] == 3 ? "".COLUMN_RESETS_DAY." desc, ".COLUNN_ASCENCAO." desc" : "".COLUNN_ASCENCAO." desc"))))." , cLevel desc");
             if($_GET['period'] == 0){
                $name_period = "REAL";
             }
             elseif($_GET['period'] == 1){
             ...
             $this->returnRanking .= "<div id=\"mtoporanking\"><div id=\"mtoponome\"><span>TOP PATENTES</span></div></div>";
             $posicao = 1;
             while($busca_dados = mssql_fetch_array($busca_dados_q)) {
              $checkMemberVipQ = $this->query("SELECT ".$TABLES_CONFIGS['WEBVIPS']['columnType']." as type FROM ".$TABLES_CONFIGS['WEBVIPS']['database'].".dbo.".$TABLES_CONFIGS['WEBVIPS']['table']." WHERE ".$TABLES_CONFIGS['WEBVIPS']['columnUsername']."='".$busca_dados['AccountID']."'");
              $checkMemberVip = mssql_fetch_object($checkMemberVipQ);
            ...
            elseif($_GET['top'] == 200) $ex_top = 200;
             ...
             while($busca_dados = mssql_fetch_array($busca_dados_q)) {
              ...
              if($ResetCount <= 0){
                  ...
                  elseif($ResetCount <= 25){
                      $Honra = 'Prata II';
                  }
                  elseif($ResetCount <= 30){
                      $Honra = 'Prata III';
                  }
                  elseif($ResetCount <= 35){
                      $Honra = 'Ouro';
                  }
                  elseif($ResetCount <= 40){
                      $Honra = 'Ouro II';
                  }
                  elseif($ResetCount <= 50){
                      $Honra = 'Ouro III';
                  }
                  elseif($ResetCount <= 75){
                      $Honra = 'Platina';
                  }
                  elseif($ResetCount <= 100){
                      $Honra = 'Platina II';
                  }
                  elseif($ResetCount <= 125){
                      $Honra = 'Platina III';
                  }
                  elseif($ResetCount <= 150){
                      $Honra = 'Diamante';
                  }
                  elseif($ResetCount <= 175){
                      $Honra = 'Diamante II';
                  }
                  elseif($ResetCount <= 200){
                      $Honra = 'Diamante III';
                  }
                  elseif($ResetCount <= 220){
                      $Honra = 'Veterano';
                  }
                  elseif($ResetCount <= 240){
                      $Honra = 'Veterano II';
                  }
        ...
        private function gerateRankingML()
        {
            global $TABLES_CONFIGS, $PANELUSER_MODULE;
            if(isset($_GET['top']) == false || empty($_GET['top'])) $top = 10;
            if($_GET['top'] == 10) $ex_top = 10;
            ...
            elseif($_GET['top'] == 200) $ex_top = 200;
             ...
             $busca_dados_q = $this->query("USE MuOnline
             Select TOP $ex_top Name, ".COLUMN_MASTERLEVEL." from dbo.MasterSkillTree ". ($_GET['period'] == 0 ? "".COLUMN_MASTERLEVELDIA."" : ($_GET['period'] == 1 ? "".COLUMN_MASTERLEVELSEM."" : ($_GET['period'] == 2 ? "".COLUMN_MASTERLEVELMES."" : "".COLUMN_MASTERLEVEL.""))) ." order by ". ($_GET['period'] == 0 ? "".COLUMN_MASTERLEVEL." desc" : ($_GET['period'] == 1 ? "".COLUMN_MASTERLEVELSEM." desc, ".COLUMN_MASTERLEVEL." desc" : ($_GET['period'] == 2 ? "".COLUMN_MASTERLEVELMES." desc, ".COLUMN_MASTERLEVEL." desc"  : ($_GET['period'] == 3 ? "".COLUMN_MASTERLEVELDIA." desc, ".COLUMN_MASTERLEVEL." desc" : "".COLUMN_MASTERLEVEL." desc")))));
             if($_GET['period'] == 0){
                $name_period = "REAL";
             }
             elseif($_GET['period'] == 1){
             ...
             while($busca_dados = mssql_fetch_array($busca_dados_q)) {
              $checkMemberVipQ = $this->query("SELECT ".$TABLES_CONFIGS['WEBVIPS']['columnType']." as type FROM ".$TABLES_CONFIGS['WEBVIPS']['database'].".dbo.".$TABLES_CONFIGS['WEBVIPS']['table']." WHERE ".$TABLES_CONFIGS['WEBVIPS']['columnUsername']."='".$busca_dados['AccountID']."'");
              $checkMemberVip = mssql_fetch_object($checkMemberVipQ);
               if($busca_dados[''.COLUMN_MASTERLEVEL.''] < 0) $pk_class = COLUMN_MASTERLEVEL;
               else $pk_class = $busca_dados[''.COLUMN_MASTERLEVEL.''];
              $ResetCount = $busca_dados[''.COLUNN_ASCENCAO.''];
              $Classe = $busca_dados['Class'];
              $Name = $busca_dados['Name'];
              $img = $busca_dados['image'];
              if($ResetCount >= 0 AND $ResetCount <= 10){
                  if(file_exists("modules/uploads/photos".$img) == false || empty($img) == true) $img = "0.jpg";
                  $imagem = '<img src="modules/uploads/photos/'.$img.'" alt="'.$Name.'" />';
              }
              elseif($ResetCount >= 100 || $ResetCount < 300 AND $Classe == 0 AND $Classe == 1 AND $Classe == 2){
              ...
              if($ResetCount <= 0){
               ...
               $this->returnRanking .= "<div id=\"qmembers\">
                      ...
                      <div id=\"mpatente\"><img src=\"templates/".TEMPLATE_DIR."/img/profile/honra/".$Honra.".png\" style=\"pointer-events: none;\"></div>
                      <div id=\"mnpatente\"><span>".$Honra."</span></div>
                      <div id=\"mmr\"><span>". $busca_dados[($_GET['period'] == 0 ? "".COLUMN_MASTERLEVEL."" : ($_GET['period'] == 1 ? "".COLUMN_MASTERLEVELSEM."" : ($_GET['period'] == 2 ? "".COLUMN_MASTERLEVELMES."" : ($_GET['period'] == 3 ? "".COLUMN_MASTERLEVELDIA."": "".COLUMN_MASTERLEVEL.""))))] ."</span></div>
                     </div>";
             }
        }		
