...
define("autenticationCache", false); // Guarda a chave de segurança em cache para não fazer requisiões a cada pagina acessada.

/*
    @Configurações do banco de dados
*/
define('HOST', 'myVm'); //Banco de dados
...
define('COLUMN_MASTERLEVEL','MasterLevel');
define('COLUMN_MASTERLEVELMES','MasterLevelMes');
define('COLUMN_MASTERLEVELDIA','MasterLevelDia');
define('COLUMN_MASTERLEVELSEM','MasterLevelSem');
define('COLUNN_ASCENCAO','acensao');
...
define('TABLE_ACENSAO','acensao');   //Coluna onde ficam armazenados a contagem de IllusionTempleScore
...
define('COLUMN_BC_RANKINGDAY','Scoreday');   //Coluna onde ficam armazenados a contagem de BloodCastleScore
define('COLUMN_BC_RANKINGSEM','Scoresem');   //Coluna onde ficam armazenados a contagem de BloodCastleScore
define('COLUMN_BC_RANKINGMES','Scoremes');   //Coluna onde ficam armazenados a contagem de BloodCastleScore
...
define('COLUMN_DS_RANKINGDAY','Scoreday');   //Coluna onde ficam armazenados a contagem de DevilSquareScore
define('COLUMN_DS_RANKINGSEM','Scoresem');   //Coluna onde ficam armazenados a contagem de DevilSquareScore
define('COLUMN_DS_RANKINGMES','Scoremes');   //Coluna onde ficam armazenados a contagem de DevilSquareScore
...
*/
$Config_SMTP['Server']      = "mail.vegasmu.com";    //Servidor SMTP
$Config_SMTP['Port']        = 587;   //Porta do servidor SMTP
$Config_SMTP['User']        = "register@vegasmu.com";  //Usuário Servidor
$Config_SMTP['Password']    = "Master@1571010"; //Senha Servidor
$Config_SMTP['Debug']       = false; //Debug (Apenas para usuários avançados)
$Config_SMTP['From']        = "register@vegasmu.com";  //Remetente dos emails
...
define('PASSWORD_UPDATE', 'as456fasf46:12312q3'); //Login e senha para auto update
...
define('FACEBOOK_LINK','https://www.facebook.com/vegasmubr/'); //Link da pagina do Facebook
...
define('TITLE_SITE', 'VEGASMU S18 EP 2.2 '); //Titulo - Nome do servidor
define('SERVER_NAME', 'VEGASMU'); //Nome do servidor
define('SERVER_SLOGAN', 'VEGASMU S18 EP 2.2 '); //Slogan do servidor
define('SERVER_VERSION', 'Season 18 EP 2.2'); //Versão do servidor
define('SERVER_DROP', '25% ~ 35%'); //Drop do servidor
define('SERVER_XP', '1200 ~ 10X'); //Xp do servidor
...
define('reCAPTCHA_SITEKEY', '6Ld1kJ0UAAAAAAHUmMs1QsUyVbc06eaxaA7P9zbI'); //Site Key from reCaptcha. Obter para seu domínio em: https://www.google.com/recaptcha/admin AIzaSyATIP9_KOda0P7lkHhsz6wChzdUq4teJHw
define('reCAPTCHA_SECRETKEY', '6Ld1kJ0UAAAAAB1KzB7l3dKuLqEh0AaansLohlZR'); //Secret Key from reCaptcha.
define('IP_SERVER', '127.0.0.1'); //ip da vps onde está o gameserver
define('PORTA_GS', '55900'); //porta do gameserver
...
*/
$Config_Find_Rooms_ConnectServer['Enable']  = true;                    //Ativar procura de salas no ConnectServer
...
$Config_Find_Rooms_ConnectServer['TLimit']    = 1;                        //Tempo de vida total da consulta

$Config_Rooms_ConnectServer[0]['Name']     = "GSPRIORITY";                //Nome da sala com o ID na lista do ConnectServer.
$Config_Rooms_ConnectServer[19]['Name']     = "GSSIEGE";                //Nome da sala com o ID na lista do ConnectServer.
$Config_Rooms_ConnectServer[290]['Name']     = "";            //Nome da sala com o ID na lista do ConnectServer.
$Config_Rooms_ConnectServer[291]['Name']     = "";            //Nome da sala com o ID na lista do ConnectServer.
$Config_Rooms_ConnectServer[140]['Name']     = "";                //Nome da sala com o ID na lista do ConnectServer.
...
$PANELUSER_MODULE['BUY_VIPS']['ACTIVES'] = array("VIP_1" => true, "VIP_2" => true, "VIP_3" => false, "VIP_4" => false, "VIP_5" => false); //Coloque os vips que voc� deseja utilizar
$PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_1'] = array(/*30 dias*/ 700, /*60 dias*/ 582, /*90 dias*/ 15,/*180 dias*/ 30,/*365 dias*/ 60); //Valor de Cash cobrado para compra de vip 1
$PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_1'] = array(/*30 dias*/ 721, /*60 dias*/ 35, /*90 dias*/ 15,/*180 dias*/ 30,/*365 dias*/ 60); //Valor de Gold cobrado para compra de vip 1
$PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_2'] = array(/*30 dias*/ 1000, /*60 dias*/ 1000, /*90 dias*/ 30,/*180 dias*/ 60,/*365 dias*/ 120); //Valor de Cash cobrado para compra de vip 2
$PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_2'] = array(/*30 dias*/ 30, /*60 dias*/ 871, /*90 dias*/ 30,/*180 dias*/ 60,/*365 dias*/ 120); //Valor de Gold cobrado para compra de vip 2
$PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_3'] = array(/*30 dias*/ 999, /*60 dias*/ 321, /*90 dias*/ 45,/*180 dias*/ 90,/*365 dias*/ 180); //Valor de Cash cobrado para compra de vip 3
$PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_3'] = array(/*30 dias*/ 1000, /*60 dias*/ 15, /*90 dias*/ 45,/*180 dias*/ 90,/*365 dias*/ 180); //Valor de Gold cobrado para compra de vip 3
...
$CLASS_CHARACTERS['CLASSCODES'] = array(/*IDENTIFICA��O*/ /*CLASSCODE*/ /*CLASSNAME*/ 
										...
										"SW" => array(3, "Soul Wizard"),
                                        "DK" => array(16, "Dark Knight"),
                                        "BK" => array(17, "Blade Knight"),
                                        "BM" => array(18, "Blade Master"),
										"DG" => array(19, "Dragon Knight"), //Algumas versões usam 19
                                        "FE" => array(32, "Fairy Elf"),
                                        "ME" => array(33, "Muse Elf"),
                                        "HE" => array(34, "High Elf"),
										"NE" => array(35, "Noble Elf"), //Algumas versões usam 35
                                        "MG" => array(48, "Magic Gladiator"),
                                        "DMM" => array(50, "Duel Master"),
										"MK" => array(51, "Magic Knight"), //Algumas season 4 usam 50
                                        "DL" => array(64, "Dark Lord"),
                                        "LE" => array(66, "Lord Emperor"),
										"EL" => array(67, "Empire Lord"), //Algumas season 4 usam 66
                                        "SU" => array(80, "Summoner"),
                                        "BS" => array(81, "Blood Summoner"),
                                        "DMS" => array(82, "Dimension Master"),
										"DS" => array(83, "Dimension Summoner"),										//Algumas versões usam 83
                                        "RF" => array(96, "Rage Fighter"),
                                        "FM" => array(97, "Fist Master"),
										"FB" => array(98, "Fist Blazer"),
										"GL" => array(112, "Grow Lancer"),
										"ML" => array(114, "Mirage Lancer"),
										"SL" => array(115, "Shining Lancer")
                                        );
                                        
/*
    @Configurações do cadastro.
*/                                                                                    
$REGISTER_SETTINGS['EMAIL_ACTIVE'] = true; //Ativação por email [TENHA CERTEZA QUE SEU SERVIDOR DE SMTP ESTA FUNCIONANDO PARA ATIVAR ESTA OPÇÂO! TESTE O CADASTRO APÓS A ATIVA��O!].
