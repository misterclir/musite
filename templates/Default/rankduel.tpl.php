...
<div class="container youplay-news">
    ...
    <div class="col-md-9 col-md-push-3">
        ...
        <div role="tabpanel">
            ...
            <h2 class="mt-0 mb-30 ml-20">Top Duels</h2>
...
$query=mssql_query("SELECT TOP 50 Name,WinScore,LoseScore FROM RankingDuel ORDER BY WinScore DESC, LoseScore ASC");
while($row=mssql_fetch_assoc($query)){
$namez=$row['Name'];
$rst[1]=$row['WinScore'];
$rst[3]=$row['LoseScore'];
$querychar=mssql_query("SELECT cLevel,AccountID,Class from ".DATABASE_ACCOUNTS.".dbo.Character where Name='".$namez."'");
$rowchar=mssql_fetch_assoc($querychar);
$rst[2]=$rowchar['cLevel'];
$LoginChar=$rowchar['AccountID'];
...
if($rowchar['Class'] == 0){$classe="Dark Wizard";}
elseif($rowchar['Class'] == 1){$classe="Soul Master";}
elseif($rowchar['Class'] == 2){$classe="Grand Master";}
elseif($rowchar['Class'] == 3){$classe="Grand Master";}
elseif($rowchar['Class'] == 16){$classe="Dark Knight";}
elseif($rowchar['Class'] == 17){$classe="Blade Knight";}
elseif($rowchar['Class'] == 18){$classe="Blade Master";}
elseif($rowchar['Class'] == 19){$classe="Blade Master";}
elseif($rowchar['Class'] == 32){$classe="Fairy Elf";}
elseif($rowchar['Class'] == 33){$classe="Muse Elf";}
elseif($rowchar['Class'] == 34){$classe="High Elf";}
elseif($rowchar['Class'] == 35){$classe="High Elf";}
elseif($rowchar['Class'] == 48){$classe="Magic Gladiator";}
elseif($rowchar['Class'] == 49){$classe="Duel Master";}
elseif($rowchar['Class'] == 50){$classe="Duel Master";}
elseif($rowchar['Class'] == 64){$classe="Dark Lord";}
elseif($rowchar['Class'] == 65){$classe="Lord Emperor";}
elseif($rowchar['Class'] == 66){$classe="Lord Emperor";}
elseif($rowchar['Class'] == 80){$classe="Summoner";}
elseif($rowchar['Class'] == 81){$classe="Blood Summoner";}
elseif($rowchar['Class'] == 82){$classe="Dimension Master";}
elseif($rowchar['Class'] == 83){$classe="Dimension Master";}
elseif($rowchar['Class'] == 96){$classe="Rage Fighter";}
elseif($rowchar['Class'] == 97){$classe="First Master";}
elseif($rowchar['Class'] == 98){$classe="First Master";}
