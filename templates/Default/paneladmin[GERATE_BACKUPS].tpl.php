	...
	<!-- PAGE CONTENT -->
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="panel.php?panel=paneladmin&amp;option=GERATE_BACKUPS&amp;Write=true" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Gerar Backup</strong></h3>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Banco de dados</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" style="cursor: pointer;">
                                                {#DATABASE_LIST}
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Nome do Arquivo</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" value="{#FILE_NAME_SUGESTION}">
                                            </div>                                            
                                            <span class="help-block">(Recomendamos não alterar)</span>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Salvar Em</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-floppy-o"></span></span>
                                                <input type="text" class="form-control" value="C:\Backups\">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-footer">                                   
                                    <button class="btn btn-primary pull-right">Criar Backup</button>
                                </div>
                            </div>
                            </form>
