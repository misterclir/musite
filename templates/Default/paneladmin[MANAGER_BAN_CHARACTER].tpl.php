	...
	<!-- PAGE CONTENT -->
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="panel.php?panel=paneladmin&amp;option=MANAGER_BAN_CHARACTER&amp;Write=true" method="post">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Personagem</label>
