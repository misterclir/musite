...
<div class="container youplay-news">
    ...
    <div class="col-md-9 col-md-push-3">
        ...
        <div role="tabpanel">
            ...
            <h2 class="mt-0 mb-30 ml-20">Top Resets</h2>

            <!-- Nav tabs -->
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#all" aria-controls="all" role="tab" data-toggle="tab">Geral</a>
                </li>
                <li role="presentation" class=""><a href="#month" aria-controls="month" role="tab" data-toggle="tab">Mensal</a>
                </li>
                <li role="presentation" class=""><a href="#week" aria-controls="week" role="tab" data-toggle="tab">Semanal</a>
                </li>
                <li role="presentation" class=""><a href="#day" aria-controls="day" role="tab" data-toggle="tab">Diário</a>
                </li>
            </ul>
...
$query=mssql_query("SELECT TOP 50 Name,cLevel,AccountID,Class,ResetCount FROM Character WHERE ctlcode !='32' AND ctlcode !='8' ORDER BY ResetCount DESC, cLevel DESC");
while($row=mssql_fetch_assoc($query)){
$namez=$row['Name'];
$rst[1]=$row['ResetCount'];
$rst[2]=$row['cLevel'];
$horas=floor($row['OnlineHour'] / 60);
$minutos=floor($row['OnlineHour'] - ($horas * 60));
$rst[3]="".$horas."h e ".$minutos."min";
$LoginChar=$row['AccountID'];
$query2=mssql_query("select TOP 1 * from GuildMember Where Name ='".$namez."'");
$row2=mssql_fetch_assoc($query2);
$query3=mssql_query("select TOP 1 * from MEMB_INFO Where memb___id ='".$LoginChar."'");
...
?>
    ...
    <tr>
        ...
        <th>Guild</th>
        <th>Level</th>
        <th>Resets Month</th>    </tr>
    </thead>
    <tbody>
<?
include("modules/settings.php");
 $query=mssql_query("SELECT TOP 50 Name,cLevel,AccountID,Class,ResetCountMonth FROM Character WHERE ctlcode !='32' AND ctlcode !='8' ORDER BY ResetCountMonth DESC, cLevel DESC");
while($row=mssql_fetch_assoc($query)){
$namez=$row['Name'];
$rst[1]=$row['ResetCountMonth'];
$rst[2]=$row['cLevel'];
$LoginChar=$row['AccountID'];
$query2=mssql_query("select TOP 1 * from GuildMember Where Name ='".$namez."'");
$row2=mssql_fetch_assoc($query2);
...
$query=mssql_query("SELECT TOP 50 Name,cLevel,AccountID,Class,ResetCountWeek FROM Character WHERE ctlcode !='32' AND ctlcode !='8' ORDER BY ResetCountWeek DESC, cLevel DESC");
while($row=mssql_fetch_assoc($query)){
$namez=$row['Name'];
$rst[1]=$row['ResetCountWeek'];
$rst[2]=$row['cLevel'];
$LoginChar=$row['AccountID'];
$query2=mssql_query("select TOP 1 * from GuildMember Where Name ='".$namez."'");
$row2=mssql_fetch_assoc($query2);
...
$query=mssql_query("SELECT TOP 50 Name,cLevel,AccountID,Class,ResetCountDay FROM Character WHERE ctlcode !='32' AND ctlcode !='8' ORDER BY ResetCountDay DESC, cLevel DESC");
while($row=mssql_fetch_assoc($query)){
$namez=$row['Name'];
$rst[1]=$row['ResetCountDay'];
$rst[2]=$row['cLevel'];
$LoginChar=$row['AccountID'];
$query2=mssql_query("select TOP 1 * from GuildMember Where Name ='".$namez."'");
$row2=mssql_fetch_assoc($query2);
    ...
    <div class="col-md-3 col-md-pull-9">
        ...
        <div class="side-block">
            ...
            <div class="block-content p-0 col-md-12 submenu-col">
                    ...
                    <div class="item angled-bg active" id="rr">
                        <div class="row">
