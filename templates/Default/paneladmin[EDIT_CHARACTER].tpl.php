	...
	<!-- PAGE CONTENT -->
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="panel.php?panel=paneladmin&amp;option=EDIT_CHARACTER&amp;Write=true" method="post">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">                                   
                                    <button class="btn btn-primary pull-right">Carregar</button>
                                </div>
                            </div>
                            </form>
