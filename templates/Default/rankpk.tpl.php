...
<div class="container youplay-news">
    ...
    <div class="col-md-9 col-md-push-3">
        ...
        <div role="tabpanel">
            ...
            <h2 class="mt-0 mb-30 ml-20">Top Assassinos (PK's)</h2>
...
$query=mssql_query("SELECT TOP 50 Name,cLevel,AccountID,Class,PKCount FROM Character WHERE ctlcode !='32' AND ctlcode !='8' ORDER BY PKCount DESC, ResetCount DESC");
