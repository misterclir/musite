...
<div class="container youplay-news">
    ...
    <div class="col-md-9 col-md-push-3">
        ...
        <div role="tabpanel">
            ...
            <h2 class="mt-0 mb-30 ml-20">Top BloodCastle Score</h2>
...
$query=mssql_query("SELECT TOP 50 Name,Score FROM RankingBloodCastle ORDER BY Score DESC");
...
$query3=mssql_query("SELECT TOP 1 cLevel,AccountID,Class,".COLUMN_RESETS." FROM ".DATABASE_ACCOUNTS.".dbo.Character WHERE Name='".$namez."'");
