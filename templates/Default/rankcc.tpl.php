...
<div class="container youplay-news">
    ...
    <div class="col-md-9 col-md-push-3">
        ...
        <div role="tabpanel">
            ...
            <h2 class="mt-0 mb-30 ml-20">Top ChaosCastle Score</h2>
...
$query=mssql_query("SELECT TOP 50 Name,Score FROM RankingChaosCastle ORDER BY Score DESC");
while($row=mssql_fetch_assoc($query)){
$namez=$row['Name'];
$rst[1]=$row['Score'];
$query2=mssql_query("select TOP 1 * from ".DATABASE_ACCOUNTS.".dbo.MEMB_INFO Where memb___id ='".$LoginChar."'");
$row2=mssql_fetch_assoc($query2);
$query3=mssql_query("select TOP 1 cLevel,AccountID,Class,".COLUMN_RESETS." as Resets from ".DATABASE_ACCOUNTS.".dbo.Character WHERE Name='".$namez."'");
