...
<form action="panel.php?panel=double_vault&amp;Write=true#!" method="post">
    <h3>Alterar Bau:</h3>
        <div class="form-group">
            <label class="control-label col-sm-2" for="userPwd">Minha senha:</label>
            <div class="col-sm-10">
                <div class="youplay-input">
                    <input type="password" id="userPwd" name="userPwd" maxlength='10'>
                </div>
            </div>
        </div>
        <div class="form-group">
