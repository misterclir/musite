	...
	<!-- PAGE CONTENT -->
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="panel.php?panel=paneladmin&amp;option=TRANSFORM_VIP&amp;Write=true" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Transformar Vips</strong></h3>
                                ...
                                <div class="panel-footer">                                   
                                    <button class="btn btn-primary pull-right">Prosseguir</button>
                                </div>
                            </div>
                            </form>
