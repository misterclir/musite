...
<h3 class="mt-60 mb-20">Programa de indica&ccedil;&atilde;o</h3>
<table class="table table-bordered" style="border: solid 2px #907d22;">
    <tbody>       
    <tr>
        <td style="width: 200px;">
            <p>Link para indica&ccedil;&atilde;o</p>
        </td>
        <td>
            <p> {#SITE_URL}index.php?dv={#MEU_LINK} </p>
        </td>
    </tr>
    <tr>
        <td style="width: 200px;">
        ...
        <td>
            <p>Possuo {#INDICADOS} indicado(s)</p>
        </td>
    </tr>
    <tr>
        <td style="width: 200px;">
        ...
        <td>
            <p>At&eacute; agora j&aacute; ganhei: {#MEUS_PONTOS} Ponto(s) por indica&ccedil;&atilde;o. </p>
        </td>
    </tr>   
    <tr>
    <tr>
        ...
        <td>
            <p>Trocar "Pontos" por "{#MOEDA_INDICACAO}": <a href="panel.php?panel=trocar_pontos#!" class="btn btn-xs"> Trocar </a></p>
        </td>   
    </tr>
    <tr>
        <td>
        ...
        <td>
            <small>Atrav&eacute;s deste sistema, voc&ecirc; receber&aacute; {#MOEDA_INDICACAO} em conformidade com o avan&ccedil;o de seus convidados. Basta divulgar o link e quando um deles acess&aacute;-lo, ser&atilde;o armazenadas no navegador as informa&ccedil;&otilde;es da indica&ccedil;&atilde;o.</small>
        </td>
    </tr>
    </tbody>
</table>
