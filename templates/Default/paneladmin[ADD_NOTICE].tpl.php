{#INCLUDE:sidebarAdmin}
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">Adicionar Notícias</h3></header>
...
<div id="box_spacer">
  ...
  <script>
                      ...
                      <form action="?page=paneladmin&amp;option=ADD_NOTICE&amp;Write=true" method="post" name="noticeFrom">
                       	<em>Titulo:</em><input name="subject" type="text" class="inputbox" value="" maxlength="50" /> <br />
                       	<em>Notícia:</em><br /><fieldset><textarea name="content" id="content">Aceita codigos HTML.</textarea><br /></fieldset>
