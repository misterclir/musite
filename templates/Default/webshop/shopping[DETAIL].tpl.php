                ...
                <table class="WebShopButtons center" border="0"> 
                    <tr>
                        <tr>
							...
							<td class="td-space"><b id="novo_preco" style="color:#FF8E13; font-size:20px;">{#NormalPrice} <span>{#Coin_1}</span> </b><br><button class="btn btn-sm"  onclick="javascript: document.getElementById('FinishBuyTD').style.display = 'block';document.getElementById('FinishBuyTDCash').style.display = 'none'; "><b>COMPRAR</b></button></td>
                            <?php endif; if(IS_CASHITEM == 1): ?>
							<td class="td-space"><b id="novo_preco2" style="color:#4C4C4C;font-size:20px;">{#NormalPrice2} <span>{#Coin_2}</span></b><br><button class="btn btn-sm"  onclick="javascript: CheckOptCash();"><b>COMPRAR</b></button></td>
							<?php endif; ?>
						</tr>
                    </tr>
               </table>
