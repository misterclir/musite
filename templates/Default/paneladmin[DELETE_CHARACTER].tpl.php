	...
	<!-- PAGE CONTENT -->
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="panel.php?panel=paneladmin&amp;option=DELETE_CHARACTER&amp;Write=true" method="post">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Editar Personagem</strong></h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="character" class="form-control" value="" placeholder="Digite o Personagem">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-footer">                                   
                                    <button class="btn btn-primary pull-right">Deletar Personagem</button>
                                </div>
                            </div>
                            </form>
