    ...
    <div id="mtwmci"> 
        ...
        <div class="sub_wrap">
            <div id="etc">
                ...
                <h1 class="topomenumeio">Distribuir pontos</h1><br>

                <div class="legend" style="margin-bottom: 1px;">
                    <h3 class="legend-title"><span style="font-size: 13px;">Distribuir pontos</span></h3>
                    <div style="margin-bottom: 8px; margin-top: 10px;">
                        <form action="panel.php?panel=settings&amp;Write=2#!" method="post">
                            <em>Personagem:</em><br />
                            <select name='personagem' class="inputbox" onchange="location='panel.php?panel=distribute_points&amp;character='+this.options[this.selectedIndex].value">
