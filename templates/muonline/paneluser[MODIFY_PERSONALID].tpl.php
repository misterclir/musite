    ...
    <div id="mtwmci"> 
        ...
        <div class="sub_wrap">
            <div id="etc">
                ...
                <h1 class="topomenumeio">Alterar Personal ID</h1><br>
                ...
                <div class="legend" style="margin-bottom: 25px;">
                    <h3 class="legend-title"><span style="font-size: 13px;">Alterar Personal ID</span></h3>
                    <div style="margin-bottom: 8px; margin-top: 10px;">
                        <form action="panel.php?panel=modify_personalid&amp;Write=true#!" method="post">
                            <em>Personal ID:</em><br /><input style="margin-top:4px;" name='pid' type='password' class="inputbox" maxlength='7' /><br />
