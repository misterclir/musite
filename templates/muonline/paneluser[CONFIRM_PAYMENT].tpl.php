    ...
    <div id="mtwmci"> 
        ...
        <div class="sub_wrap">
            <div id="etc">
                ...
                <h1 class="topomenumeio">Confirmar pagamento</h1><br>
                    ...
                    function show_hide_blocks(name) { 
                        ...
                        return true;
                            ...
                            <div style="margin-bottom: 8px; margin-top: 10px;">
                                ...
                                <form action="panel.php?panel=confirm_payment&amp;Write=true#!" method="post">   
                                    ...
                                    <tr>
                                        <td style="width:65%; background: none;" valign="top">
                                            ...
                                            Qual banco você usou<br />
                                                <input name="bank" type="radio" value="Banco Bradesco ou Banco Postal" onclick="javascript:show_hide_blocks('Opt_Bradesco');" /> Banco Bradesco<br />
                                                ...
                                                <input name="bank" type="radio" value="PagSeguro" /> PagSeguro<br />
                                        </td>
                                        <td style="width:35%; background: none;">
                                            ...
                                            Pago em<br />
                                            <select name="pago_em" class="inputbox" />
                                                <option></option>
