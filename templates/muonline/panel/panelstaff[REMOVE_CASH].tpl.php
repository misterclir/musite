...
<body>
    ...
    <div class="page-title">
      <div class="row">
        <div class="col s12 m9 l10">
          <h1><i class="mdi-content-clear"></i> Remover {#CASH_NAME}</h1>
          <ul>
           <li><a href="?panel=panelstaff"><i class="fa fa-home"></i> Início</a> /</li>
           <li><a href="#"> Ferramentas</a> /</li>
           <li><a href="#"> Remover {#CASH_NAME}</a></li>
         </ul>
       </div>
  ...
  <br />
    ...
    <form action="?panel=panelstaff&amp;option=REMOVE_CASH&amp;Write=true" method="post">
      <div class="input-field">
        <input id="input-name2" name="account" type="text" value="">
        <label for="input-name2">Login</label>
      </div>
      <div class="input-field">
      ...
      <div class="input-field">
        <input id="input-name3" name="amount" type="text" value="" required>
        <label for="input-name3">Valor</label>
      </div>
      <br />
