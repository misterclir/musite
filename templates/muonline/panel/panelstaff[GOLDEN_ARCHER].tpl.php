...
<body>
    ...
    <div class="page-title">
      <div class="row">
        <div class="col s12 m9 l10">
          <h1><i class="mdi-action-polymer"></i> Golden Archer</h1>
          <ul>
           <li><a href="?panel=panelstaff"><i class="fa fa-home"></i> Início</a> /</li>
           <li><a href="#"> Ferramentas</a> /</li>
           <li><a href="#"> Golden Archer</a></li>
         </ul>
       </div>
  ...
  <br />
    ...
    <a href="?panel=panelstaff&option=GOLDEN_ARCHER&action=createSerial" class="btn">Criar serial para um determinado login</a>
