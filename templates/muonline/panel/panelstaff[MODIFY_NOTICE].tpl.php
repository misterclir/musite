...
<body>
    ...
    <div class="page-title">
      <div class="row">
        <div class="col s12 m9 l10">
          <h1><i class="mdi-editor-mode-edit"></i> Modificar Notícia</h1>
          <ul>
           <li><a href="?panel=panelstaff"><i class="fa fa-home"></i> Início</a> /</li>
           <li><a href="#"> Ferramentas</a> /</li>
           <li><a href="#"> Modificar Notícia</a></li>
         </ul>
       </div>
  ...
  <script>
          ...
          <form action="?page=panelstaff&amp;option=MODIFY_NOTICE&amp;Write=true" method="post">
