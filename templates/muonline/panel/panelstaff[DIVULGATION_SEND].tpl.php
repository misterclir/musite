...
<body>
    ...
    <div class="page-title">
      <div class="row">
        <div class="col s12 m9 l10">
          <h1><i class="fa fa-send"></i> Enviar Divulgações</h1>
          <ul>
           <li><a href="?panel=panelstaff"><i class="fa fa-home"></i> Início</a> /</li>
           <li><a href="#"> Ferramentas</a> /</li>
           <li><a href="#"> Enviar Divulgações</a></li>
         </ul>
       </div>
  ...
  <div style="margin-top: 10px;" id="logs_">
    {#RespostWrite}
      <form action='?panel=panelstaff&amp;option=DIVULGATION_SEND&amp;Write=true' method="post">
      ...
      <strong>Preencha todos os campos abaixo para abrir o pedido!</strong>
        ...
        <table>
          <tr>
            ...
            <td>
              <div class="input-field">
                <textarea id="description" class="materialize-textarea" name="description" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-validation-threshold="10" data-parsley-minlength-message="Descrição" required></textarea>
