...
<body>
    ...
    <div class="page-title">
      <div class="row">
        <div class="col s12 m9 l10">
          <h1><i class="ion-edit"></i> Editar Personagem</h1>
          <ul>
           <li><a href="?panel=panelstaff"><i class="fa fa-home"></i> Início</a> /</li>
           <li><a href="#"> Ferramentas</a> /</li>
           <li><a href="#"> Editar Personagem</a></li>
         </ul>
       </div>
  ...
  <br />
    ...
    <form action="?page=panelstaff&amp;option=EDIT_CHARACTER&amp;Write=true" method="post">
      <div class="input-field">
        <input id="input-name" name="character" type="text" value="" required>
        <label for="input-name">Personagem</label>
      </div>
      <br />
      <button class="btn">Carregar Dados</button>
    </form>
