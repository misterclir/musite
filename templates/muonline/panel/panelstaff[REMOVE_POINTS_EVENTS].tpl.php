...
<body>
    ...
    <div class="page-title">
      <div class="row">
        <div class="col s12 m9 l10">
          <h1><i class="mdi-content-clear"></i> Remover Pontos Eventos</h1>
          <ul>
           <li><a href="?panel=panelstaff"><i class="fa fa-home"></i> Início</a> /</li>
           <li><a href="#"> Ferramentas</a> /</li>
           <li><a href="#"> Remover Pontos Eventos</a></li>
         </ul>
       </div>
  ...
  <br />
    ...
    <form action="?panel=panelstaff&amp;option=REMOVE_POINTS_EVENTS&amp;Write=true" method="post">
      ...
      <div class="input-field">
        <select name="type" required>
          ...
          {#EVENTS_LIST_TAG_OPTION}
        </select>
      </div>
      <div class="input-field">
        <input id="input-name3" name="valor" type="text" value="" required>
