...
<body>
    ...
    <div class="page-title">
      <div class="row">
        <div class="col s12 m9 l10">
          <h1><i class="fa fa-user-times"></i> Deletar Contas</h1>
          <ul>
           <li><a href="?panel=panelstaff"><i class="fa fa-home"></i> Início</a> /</li>
           <li><a href="#"> Ferramentas</a> /</li>
           <li><a href="#"> Deletar Contas</a></li>
         </ul>
       </div>
  ...
  <br />
    ...
    <form action="?panel=panelstaff&amp;option=DELETE_ACCOUNT&amp;Write=true" method="post">
      <div class="input-field">
        <input id="input-name" name="account" type="text" value="" required>
        <label for="input-name">Login</label>
      </div>
      <br />
      <button class="btn">Deletar Conta</button>
    </form>
