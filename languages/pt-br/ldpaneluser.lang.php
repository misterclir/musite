...
DEFINE("LDPU_CONFIRM_DEPOSIT_SUCCESS", "Sua confirmação foi enviada com sucesso!<br/>Aguarde que nossa equipe confirme seu pagamento.<br/>Para ver o status da sua confirmação acesse o link: <a href='?panel=log_buys&amp;Write=1#!'>Ver confirmações</a><br/>Obrigado.");
