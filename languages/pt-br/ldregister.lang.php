...
DEFINE("REGISTER_EMAIL_IN_USE", "Erro: Email em uso!");
...
DEFINE("REGISTER_SUCCESS_REGISTER", "<strong>Cadastro realizado com sucesso!</strong><br />Login: <strong>%s</strong><br />Senha: <strong>%s</strong><br />Apelido: <strong>%s</strong><br />Email: <strong>%s</strong><br />Obrigado.<br />Tenha um bom jogo.");
...
DEFINE("CREATE_ACCOUNT_EMAIL_BODY", "Atenção!<br />Esse e-mail é uma mensagem automatica gerada pelo ".TITLE_SITE."!<br /><br />Seu Login de acesso é: %s<br /><br />Sua Senha de acesso é: %s<br /><br />Seu Apelido é: %s<br />Seu Email é: %s<br /><br />Tenha um bom jogo!<br />Equipe ".TITLE_SITE.".<br />");
