	...
	class Items extends Vault {
		...
		public function GetSerial() {
            if(defined("WZ_GETITEMSERIAL") == false)
                $SQL_Q = $this->query("exec ".DATABASE_ACCOUNTS.".dbo.WZ_GetItemSerial");
            else
			    $SQL_Q = $this->query("exec ".DATABASE_ACCOUNTS.".dbo.".constant("WZ_GETITEMSERIAL"));
