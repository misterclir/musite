	...
	switch($_GET['panel'])
{
    ...
    default:
		...
		private function loadOptionsDefault()
		{
			...
			$findLastCharactersQ = $this->query("SELECT Name,Class,".COLUMN_RESETS.",PkCount,CtlCode FROM Character WHERE AccountID='". $_SESSION['LOGIN'] ."'");
			...
			else
			{
				...
				{
					$tmpChars .= "<tr><td>". $findLastCharacters[0] ."</td><td>". $this->classNameDefine($findLastCharacters[1]) ."</td><td>". $findLastCharacters[2] ."</td><td>". ($findLastCharacters[3] > 0 ? "Sim":"N&atilde;o") ."</td></tr>";
			...
			switch($_GET['Write'])
			{
				...
				case 1:
					...
					switch($vip[0])
					{
						case 1:
							...
							elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_1'][0];
							elseif($vip[1] == 60) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_1'][1];
	                    ...
	                    case 2:
	                        ...
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_2'][0];
	                        elseif($vip[1] == 90) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_2'][1];
	                    ...
	                    case 3:
	                        ...
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_3'][0];
	                    ...
	                    case 4:
	                        ...
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_4'][0];
						...
						case 5:
	                        ...
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE1']['VIP_5'][0];
				...
				case 2:
					...
					switch($vip[0])
					{
						case 1:
	                        if($PANELUSER_MODULE['BUY_VIPS']['ACTIVES']["VIP_1"] == false) $error = "<div class='qdestaques'>".LDPU_BUY_VIP_DISABLED_TYPE."</div>";
							elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_1'][0];
							elseif($vip[1] == 60) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_1'][1];
	                    ...
	                    case 2:
	                        if($PANELUSER_MODULE['BUY_VIPS']['ACTIVES']["VIP_2"] == false) $error = "<div class='qdestaques'>".LDPU_BUY_VIP_DISABLED_TYPE."</div>";
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_2'][0];
	                        elseif($vip[1] == 90) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_2'][1];
	                    ...
	                    case 3:
	                        if($PANELUSER_MODULE['BUY_VIPS']['ACTIVES']["VIP_3"] == false) $error = "<div class='qdestaques'>".LDPU_BUY_VIP_DISABLED_TYPE."</div>";
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_3'][0];
	                    ...
	                    case 4:
	                        if($PANELUSER_MODULE['BUY_VIPS']['ACTIVES']["VIP_4"] == false) $error = "<div class='qdestaques'>".LDPU_BUY_VIP_DISABLED_TYPE."</div>";
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_4'][0];
						...
						case 5:
							if($PANELUSER_MODULE['BUY_VIPS']['ACTIVES']["VIP_5"] == false) $error = "<div class='qdestaques'>".LDPU_BUY_VIP_DISABLED_TYPE."</div>";
	                        elseif($vip[1] == 30) $this->priceVip = $PANELUSER_MODULE['BUY_VIPS']['PRICE2']['VIP_5'][0];
		...
		private function loadOptionsTrocarPontos()
        {
			...
			if($_GET['action'] == true)
			{
				if(is_numeric($_POST['pontos']) == false) return $ldTpl->set("RESULTTPL", "<div class=\"qdestaques\">Você deve colocar a quantidade de Pontos que deseja trocar</div>");
