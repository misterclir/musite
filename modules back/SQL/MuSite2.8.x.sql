...
GO
ALTER TABLE dbo.MEMB_INFO ADD indicado int NOT NULL DEFAULT 0
GO
ALTER TABLE dbo.MEMB_INFO ADD pontos_indicado int NOT NULL DEFAULT 0
GO
ALTER TABLE dbo.MEMB_INFO ADD indicacao int NOT NULL DEFAULT 0
GO
ALTER TABLE dbo.MEMB_INFO ADD ip nvarchar(50) NULL 
GO
...
CREATE TABLE [dbo].[webRankingMedalAndTrofeu](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[Name] [varchar](12) COLLATE Latin1_General_CI_AS NOT NULL,
	[trofeu_mreset_ouro] [int] NOT NULL,
	[trofeu_reset_ouro] [int] NOT NULL,
	[trofeu_hora_ouro] [int] NOT NULL,
	[trofeu_hero_ouro] [int] NOT NULL,
	[trofeu_pk_ouro] [int] NOT NULL,
	[trofeu_total_ouro] [int] NOT NULL,
	[trofeu_mreset_prata] [int] NOT NULL,
	[trofeu_reset_prata] [int] NOT NULL,
	[trofeu_hora_prata] [int] NOT NULL,
	[trofeu_hero_prata] [int] NOT NULL,
	[trofeu_pk_prata] [int] NOT NULL,
	[trofeu_total_prata] [int] NOT NULL,
	[trofeu_mreset_bronze] [int] NOT NULL,
	[trofeu_reset_bronze] [int] NOT NULL,
	[trofeu_hora_bronze] [int] NOT NULL,
	[trofeu_hero_bronze] [int] NOT NULL,
	[trofeu_pk_bronze] [int] NOT NULL,
	[trofeu_total_bronze] [int] NOT NULL,
	[medal_mreset_ouro] [int] NOT NULL,
	[medal_reset_ouro] [int] NOT NULL,
	[medal_hora_ouro] [int] NOT NULL,
	[medal_hero_ouro] [int] NOT NULL,
	[medal_pk_ouro] [int] NOT NULL,
	[medal_total_ouro] [int] NOT NULL,
	[medal_mreset_prata] [int] NOT NULL,
	[medal_reset_prata] [int] NOT NULL,
	[medal_hora_prata] [int] NOT NULL,
	[medal_hero_prata] [int] NOT NULL,
	[medal_pk_prata] [int] NOT NULL,
	[medal_total_prata] [int] NOT NULL,
	[medal_mreset_bronze] [int] NOT NULL,
	[medal_reset_bronze] [int] NOT NULL,
	[medal_hora_bronze] [int] NOT NULL,
	[medal_hero_bronze] [int] NOT NULL,
	[medal_pk_bronze] [int] NOT NULL,
	[medal_total_bronze] [int] NOT NULL
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[webNotificationPanel](
	[id] [smallint] IDENTITY(1,1) NOT NULL,
